...
int main()
{
    ...
    while (t--)
    {
        ...
        // Choose ONE solution to run
        SpaceOptimizedSolution solver;
        // RecursionSolution solver;        // will TLE
        // MemoizationSolution solver;
        // TabulationSolution solver;

        cout << solver.solve(n, heights) << endl;
    }
    return 0;
}
